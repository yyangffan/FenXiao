 ...
 */
public class AllMembersFragment extends BaseFragment implements MineMembersInfo {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_all_members, container, false);
        init(v);
        onMessage();
        return v;
    }
    ...
    public void init(View v) {
        mListView = (ListView) v.findViewById(R.id.allmembers_lv_id);

        preferences = AllMembersFragment.this.getActivity().getSharedPreferences("user", Context.MODE_PRIVATE);
    ...
    public void onMessage() {
        ...
        mList.add(map);
//        mAdapter = new OneDeckFragmentAdapter(AllMembersFragment.this.getActivity(), mList);
//        mListView.setAdapter(mAdapter);
//        mAdapter.setOnItemClicksAllMembers(AllMembersFragment.this);
    ...
    public void onItemClicks(RelativeLayout mRelativeLayout, List<Map<String, Object>> list) {
        mRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AllMembersFragment.this.getActivity(), MembersDetailActivity.class);//成员详情页
