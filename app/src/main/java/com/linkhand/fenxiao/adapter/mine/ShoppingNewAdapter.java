...
public class ShoppingNewAdapter extends BaseAdapter {
    Context context;
    List<ShoppingCartListNewFeng.InfoBean> beanList;
    ShoppingInfo mShoppingInfo;
    List<Map<String, Object>> list1;
    SharedPreferences preferences;
    SharedPreferences.Editor editor;

    public ShoppingNewAdapter(Context context, List<ShoppingCartListNewFeng.InfoBean> beanList, List<Map<String, Object>> list1) {
        this.context = context;
        this.beanList = beanList;
        this.list1 = list1;
    }

    public void setData(List<ShoppingCartListNewFeng.InfoBean> beanList) {
        this.beanList = beanList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShoppingNewAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new ShoppingNewAdapter.ViewHolder();
            convertView = LayoutInflater.from
                    (this.context).inflate(R.layout.shopping_item_layout, null, false);
            ...
            holder.mll_all= (LinearLayout) convertView.findViewById(R.id.shopping_ll_all);
        ...
        if (this.beanList != null) {
            ...
            ShoppingCartListNewFeng.InfoBean childMap = beanList.get(position);
            ...
            List<ShoppingCartListNewFeng.InfoBean.SpeciBean> speciBeen = childMap.getSpeci();//规格
...
//                holder.mfailure.setVisibility(View.GONE);
                holder.mtv_cancel.setVisibility(View.GONE);
