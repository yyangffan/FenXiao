...
public class TuanGRcAdapter extends RecyclerView.Adapter<TuanGRcAdapter.ViewHolder> {
    Context context;
    ...
    private final String mMater_name;
    private final String mSon_name;
    private OnItemClickListener mOnItemClickListener;

    public TuanGRcAdapter(Context context, List<GroupListFeng.InfoBean> stringList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide.with(context).load(C.TU + thumb).apply(requestOptions).into(holder.mTu);
