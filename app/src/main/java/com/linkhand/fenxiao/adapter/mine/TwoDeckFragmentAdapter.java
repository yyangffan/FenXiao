...
public class TwoDeckFragmentAdapter extends BaseAdapter {
    Context context;
    MineMembersInfo mMineMembersInfo;
    List<MyTeamFeng.InfoBean._$1Bean> beanListtwo;

    public TwoDeckFragmentAdapter(Context context, List<MyTeamFeng.InfoBean._$1Bean> beanListtwo) {

        this.context = context;
        this.beanListtwo = beanListtwo;

    }

    @Override
    public int getCount() {
        return beanListtwo.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TwoDeckFragmentAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new TwoDeckFragmentAdapter.ViewHolder();
            ...
            holder = (TwoDeckFragmentAdapter.ViewHolder) convertView.getTag();
        }
        if (this.beanListtwo != null) {
            MyTeamFeng.InfoBean._$1Bean childOne = beanListtwo.get(position);
    ...
    public void setOnItemClicks(TwoDeckFragment mMineMembersInfo) {
