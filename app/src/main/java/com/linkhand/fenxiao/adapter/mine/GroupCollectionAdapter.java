...
public class GroupCollectionAdapter extends BaseAdapter {
    Context context;
    ...
    public GroupCollectionAdapter(Context context, List<CollectionFeng.InfoBean> beanList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GroupCollectionAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new GroupCollectionAdapter.ViewHolder();
            ...
            holder = (GroupCollectionAdapter.ViewHolder) convertView.getTag();
        }
...
//                Log.e("yh","thumb--"+thumb);
    ...
    public void setOnItemClicks(BulkCollectionFragment mCollectionInfo) {
