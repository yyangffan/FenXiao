...
public class VipDetailPageAdapter extends BaseAdapter {
    Context context;
    ...
    public VipDetailPageAdapter(Context context, VipGoodsDetailsFeng.InfoBean.SpeciBean results, LeftLVIn mLeftLVIn, int place, List<MyGoodsFeng> myList) {
