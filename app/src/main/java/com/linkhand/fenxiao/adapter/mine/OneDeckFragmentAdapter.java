...
public class OneDeckFragmentAdapter extends BaseAdapter {
    Context context;
    MineMembersInfo mMineMembersInfo;
    List<MyTeamFeng.InfoBean._$0Bean> beanListone;

    public OneDeckFragmentAdapter(Context context, List<MyTeamFeng.InfoBean._$0Bean> beanListone) {

        this.context = context;
        this.beanListone = beanListone;

    }

    @Override
    public int getCount() {
        return beanListone.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OneDeckFragmentAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new OneDeckFragmentAdapter.ViewHolder();
            ...
            holder = (OneDeckFragmentAdapter.ViewHolder) convertView.getTag();
        }
        if (this.beanListone != null) {
            MyTeamFeng.InfoBean._$0Bean childOne = beanListone.get(position);
...
//            holder.mRegistrationTv.setVisibility(View.GONE);//已注册未充值显示的
    ...
    public void setOnItemClicks(OneDeckFragment mMineMembersInfo) {
