...
/**
 * Created by 11860_000 on 2018/1/10.
 */

public class AllOrderFeng {
    ...
    public static class InfoBean {
        ...
        public String getOrder_quit() {
            return order_quit;
        }

        public void setOrder_quit(String order_quit) {
